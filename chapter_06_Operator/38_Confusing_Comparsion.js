...
console.log(true === 1);     // false  → different types  // strict equality does not coerce
...
console.log(a === b);  // false  // different references, even though they are both empty objects
